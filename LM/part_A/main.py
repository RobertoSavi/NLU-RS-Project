...
# -------------------- Model saving --------------------
path = 'models/best_hid_emb_model_0_05_good_hemb.pt'
...
with open('results/models_best_hid_emb_0_05good_hemb.txt', 'w') as f:
...
plt.legend()
plt.savefig('images/models_best_hid_emb_0_05good_hemb.jpg')  # Save the plot as an image
plt.show()
