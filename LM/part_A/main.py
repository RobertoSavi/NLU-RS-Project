...
# -------------------- Model saving --------------------
path = 'models/best_hid_emb_model_0_05.pt'
...
with open('results/models_best_hid_emb_0_05.txt', 'w') as f:
...
plt.legend()
plt.savefig('images/models_best_hid_emb_0_05.jpg')  # Save the plot as an image
plt.show()
