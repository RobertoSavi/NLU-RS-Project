...
\begin{itemize}
    ...
    \item \textit{Then I tried to increase the learning rate to 0.05, saving the results in standard_lr0_05.pt}
    \item \textit{Then, I tried to increase the batch size of training from 64 to 128 and the batch size of development and test from 128 to 256, saving the results in double_batch_size.pt}
\end{itemize}
