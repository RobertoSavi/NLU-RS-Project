...
This folder contains the code necessary for running the part 2-B of the NLU course project at the University of Trento, focused on intent classification and slot filling.
...
│   └── part/
│       ├── 2b1.yaml        # Config file for pre-trained BERT bert-base-uncased
```
...
- 2b1 for pre-trained BERT bert-base-uncased
...
**Example command:**
```bash
uv run python main.py part=2b1 testing=false
```