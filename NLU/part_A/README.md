...
│   └── part/
│       ├── 2a0.yaml        # Config file for Baseline IAS
│       ├── 2a1.yaml        # Config file for Model IAS with Bidirectionality
│       ├── 2a2.yaml        # Config file for Model IAS with Bidirectionality and Dropout layers
```
...
- 2a0 for Baseline IAS
- 2a1 for Model IAS with Bidirectionality
- 2a2 for Model IAS with Bidirectionality and Dropout layers
...
**Example command:**
```bash
uv run python main.py part=2a1 testing=false
```